...
class TestToolManager:
    ...
    def test_filter_tools_allowed_and_excluded(self):
        ...
        if len(tools) >= 3:
            ...
            filtered = manager.filter_tools(tools, allowed=allowed_names, excluded=excluded_names)
    ...
    def test_filter_tools_case_insensitive(self):
        ...
        if tools:
            ...
            filtered = manager.filter_tools(tools, allowed=tool_name.upper(), excluded="")
    ...
    def test_filter_tools_ignores_empty_names(self):
        ...
        if tools:
            ...
            filtered = manager.filter_tools(tools, allowed=f"{tools[0].name},", excluded="")
            assert len(filtered) == 1
    ...
    def test_filter_tools_with_nonexistent_names(self):
        ...
        filtered = manager.filter_tools(tools, allowed="nonexistent_tool_xyz", excluded="")
