...
class TestAgentBuilder:
    ...
    def test_builder_initialization(self, mock_cli_config, mock_tools, mock_skills, mock_root_agent_descriptions):
    ...
    def test_build_success(self, mock_cli_config, mock_tools, mock_skills, mock_root_agent_descriptions):
    ...
    def test_build_unknown_root_agent(self, mock_cli_config, mock_tools, mock_skills, mock_root_agent_descriptions):
    ...
    def test_build_cli_model_overrides_frontmatter(self, mock_cli_config, mock_tools, mock_skills, mock_root_agent_descriptions):
    ...
    def test_build_uses_frontmatter_model_if_cli_not_set(self, mock_cli_config, mock_tools, mock_skills, mock_root_agent_descriptions):
    ...
    def test_build_missing_model_raises_error(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_missing_system_prompt_raises_error(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_loads_context_if_provided(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_does_not_add_system_prompt_if_context_loaded(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_adds_system_prompt_if_fresh_conversation(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_includes_skills_in_system_prompt(self, mock_cli_config, mock_tools, mock_skills):
        ...
        with patch('wichy.agent_builder.skills_information') as mock_info:
            ...
            system_msg = [msg for msg in agent.context.context if msg["role"] == "system"][0]
            assert "Available skills: test_skill" in system_msg["content"]
    
    def test_build_skills_info_not_included_when_disabled(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_includes_env_info_by_default(self, mock_cli_config, mock_tools, mock_skills):
    ...
    def test_build_env_info_can_be_disabled(self, mock_cli_config, mock_tools, mock_skills):
