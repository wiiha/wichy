...
class TestRepl:
    ...
    def test_repl_initialization(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_run_simple_interaction(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_handles_slash_command(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_handles_context_reset_exception(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_handles_context_drop_exception(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_handles_llm_context_limit_error(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_handles_keyboard_interrupt(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_exits_on_eof(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
    ...
    def test_repl_strip_thinking_content(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
        """Test that Repl strips thinking content from responses."""
        mock_root_agent.process.return_value = "Normal text <think>Thinking</think> more text"
        ...
        with patch('wichy.repl.strip_thinking_content') as mock_strip:
            ...
            mock_strip.assert_called_once_with("Normal text <think>Thinking</think> more text")
    
    def test_repl_uses_correct_exit_code_on_eof(self, mock_root_agent, mock_prompt_session, mock_cmd_checker):
