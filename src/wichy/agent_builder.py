...
class AgentBuilder:
    ...
    def __init__(
        ...
        self.tools = tools
        self.skills = skills
        self.root_agent_descriptions = {ra.props["name"]: ra for ra in root_agent_descriptions}
        self.all_descriptions = all_descriptions if all_descriptions is not None else root_agent_descriptions
    ...
    def _add_system_prompt(self, root_agent: RootAgent, root_agent_desc: ParsedRootAgentDesc):
        """
        ...
        system_prompt = preprocess_prompt(prompt=system_prompt, verify_against=verify_against)
        
        # Add skills information if enabled
        include_skills = root_agent_desc.props.get("include_skills", "true").lower() != "false"
        if include_skills:
