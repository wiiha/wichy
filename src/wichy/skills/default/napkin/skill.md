...
First thing, every session — read `.wichy/napkin.md` before doing anything else. Internalize what's there and apply it silently. Don't announce that you read it. Just apply what you know.
...
If no napkin exists yet, create one at `.wichy/napkin.md`:
...
> CRITICAL: The napkin lives at `.wichy/napkin.md` (project-local) NOT in home directory.
